...
| **¿Cuánto cuesta?** | Desde **$20.000 COP** pago único (Freelance INICIO). Producto propio: Indie o Pro. **Todo pago único** — sin suscripciones. Sin IVA. |
...
|------|-------------------------|------------------|------------|
| **Freelance INICIO** | **$20.000** | ≈ USD 5 | 1.er proyecto de cliente (promo de entrada) |
...
## Promoción de entrada — Freelance

**Código: `DLUNIRE-INICIO`** (lanzamiento 2026) — **mínimo de entrada**

Como referencia de precio simbólico al primer despliegue: el primer permiso cuesta lo mínimo; los siguientes, tarifa de lista.
...
**Datos obligatorios al solicitar:** titular (nombre o razón social), **correo asociado al dominio**, nombre del **cliente final**, **dominio** en producción, descripción en una frase. **No** pedimos documento de identidad ni NIT del titular para Freelance. Al enviar datos acepta la [política de tratamiento de datos personales](/politica-datos) (Ley 1581 de 2012, Colombia). Plazo del certificado: orientativo **≤ 3 días hábiles**.
...
| Código promo | `DLUNIRE-INICIO` (si aplica) | Opcional |
...
- Monto en **COP** (sin IVA) y **link Wompi** u otra pasarela (o confirmación de promo `DLUNIRE-INICIO` si aplica).

### Paso 3 — Pague (si aplica)

**Precio de lista**

| Modalidad | COP | Con `DLUNIRE-INICIO` |
|-----------|-----|----------------------|
| Freelance Proyecto | $50.000 | **$20.000** (1.er proyecto) |
...
Tras confirmar pasarela, Nequi/transferencia, PayPal o Binance:
...
Sí, en su primer proyecto de cliente pagado (si el programa de entrada sigue vigente): **$20.000 COP**. Un uso por titular.
